...
echo "✅ Directorio de base de datos listo (migraciones se ejecutarán automáticamente al iniciar)"
mkdir -p "$(dirname /data/app.db)" || true

echo "Iniciando servidor en modo dev..."
exec npm run dev
