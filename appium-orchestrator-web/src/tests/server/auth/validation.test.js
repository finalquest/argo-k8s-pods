...
describe('Input Validation and Security', () => {
  describe('Input Sanitization', () => {
    ...
    test('should sanitize dangerous characters', () => {
      ...
      expect(sanitize('feature/../../../malicious')).toBe('feature_.._.._.._malicious');
      expect(sanitize('feature/..\\..\\malicious')).toBe('feature_.._.._malicious'); // Backslashes become underscores
    ...
    test('should preserve allowed characters', () => {
      ...
      expect(sanitize('feature.test-branch_name')).toBe('feature.test-branch_name');
  ...
  describe('Input Type Validation', () => {
    test('should validate branch name format', () => {
      ...
      invalidBranchNames.forEach(name => {
        if (name.trim()) { // Only test non-empty names
          expect(name.length).toBeGreaterThan(0);
